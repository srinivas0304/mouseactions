...
public class MouseActions 
{
	...
	public void mouseActions()
	{
		...
		act.moveToElement(ele).perform();//moveToElement()
		...
		act.moveToElement(ele2).click().perform();//to perform click() 
		
		WebElement ele3=driver.findElement(By.id("searchSystemUser_userName"));
		
		act.moveToElement(ele3).sendKeys(ele3, "srinivas").perform();// to perform sendKeys()
